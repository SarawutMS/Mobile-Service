    ...
    <div class="custom">
        <div class="container">
            ...
            <div class="position-absolute top-50 start-50 translate-middle label_pain">
                <canvas id="demo" width="125" height="205"></canvas>
    ...
    <Text_Edit :show-modal=on_edit_text>
        <template v-slot:body>
            ...
            <div class="row container  mt-3 " name="font_label">
                ...
                <div class=" col">
                    <select name="font" id="font" style="width: 100%; font-size: 89%;">
        ...
        <template v-slot:footer>
            <div class="btn btn-danger mx-3 text-white" @click="Obj_delete"> ลบ </div>
            <div class="btn btn-success mx-0" @click="Update_text()"> ตกลง </div>
